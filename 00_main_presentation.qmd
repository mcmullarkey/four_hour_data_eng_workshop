...
format:
  revealjs:
    logo: images/gerber_endowment_no_background.png
    incremental: true
    theme: blood
    transition: fade
...
# {background-image="images/qualtrics_recode_example.png" background-size="contain" background-repeat="no-repeat"}
...
- [UA Libraries' Data Cooperative Unit](https://data.library.arizona.edu/){preview-link="true" style="text-align: center"}
